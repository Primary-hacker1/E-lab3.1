package com.example.pro.ui.activity.mine;
...
import com.example.pro.config.TagUtils;

import com.example.pro.ui.adapter.AndroidStudyAdapter;
...
//                skipActivity(WebActivity.class, BundleUtils.buidler().put(TagUtils.web_uri,uri).build());
    ...
    protected void initView() {
        ...
        mDataBinding.titleBarLayout.centerText.setText("学习");
